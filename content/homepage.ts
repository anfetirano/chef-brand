...
export const homepageContent: HomepageContent = {
  hero: {
    ...
    facts: [
      {
        label: "Recent focus",
        value: "Restaurants, premium hospitality, brunch service, and high-volume buffet execution",
      },
      {
        label: "Languages",
    ...
    contactMethods: [
      ...
      {
        label: "LinkedIn",
        value: "Andres F. Tirano Vasquez",
        href: "https://www.linkedin.com/in/andres-f-tirano-vasquez-5792b51a1/",
      },
      {
        label: "Website",
